// 호출주소: http://localhost:3000/api/agent/searchbot
// 검색엔진 Agent기반 챗봇 구현하기
// 검색엔진 서비스로 Tavily(타빌리)Agent서비스를 이용해 
// 최신 검색결과 기반 응답 챗봇을 구현합니다.

import type { NextApiRequest, NextApiResponse } from "next";

//타빌리 Agent검색서비스 조회결과 객체 참조하기
//타빌리 Agent는 @langchain/community/tools에 기본제공되는 검색엔진 서비스입니다.
//@langchain/community패키지를 설치했으면 바로 사용가능
